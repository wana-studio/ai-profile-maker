        ...
        return (
            <div className="min-h-screen flex flex-col">
                ...
                <div className="flex-1 flex flex-col items-center justify-center px-4 text-center">
                    ...
                    <p className="text-muted-foreground mb-6">This photo may have been deleted</p>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                        <div>
                            ...
                            <p className="text-white font-medium">
                                {photo.energyLevel && photo.energyLevel < 33 ? 'Soft' : photo.energyLevel && photo.energyLevel < 66 ? 'Balanced' : 'Bold'}
                            </p>
                        </div>
                        <div>
                            <p className="text-muted-foreground">Realism</p>
                            <p className="text-white font-medium capitalize">{photo.realismLevel}</p>
                        </div>
                        <div>
            ...
            <div className="fixed bottom-18 left-0 right-0 p-4 safe-area-bottom max-w-md mx-auto">
                <div className="flex gap-3">
                    ...
                    <Button
                        ...
                        className="flex-1 h-14 gap-2 gradient-primary text-lg font-semibold"
                    >
