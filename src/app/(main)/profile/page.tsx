...
import {
    User, Crown, Bell, Shield, Trash2, LogOut, ChevronRight,
    Plus, CreditCard, HelpCircle, Star, LogIn, Upload, X
} from 'lucide-react';
...
import { useSubscriptionStore, useFaceProfilesStore, useModalStore } from '@/lib/stores';
            ...
            <div className="min-h-screen pb-20">
                ...
                >
                    ...
                    <p className="text-muted-foreground max-w-xs mb-8">
                        Access your profile, manage subscriptions, and view your saved face profiles
                    </p>
        ...
        <div className="min-h-screen pb-20">
            ...
            <div className="px-4 space-y-6">
                ...
                <motion.div
                    ...
                    className={`p-5 rounded-3xl ${isPro
                        ? 'gradient-primary'
                ...
                >
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            <div className={`p-2 rounded-xl ${isPro ? 'bg-white/20' : 'gradient-primary'}`}>
                            ...
                            <div>
                                ...
                                <p className="text-sm text-white/70">
                                    {isPro ? 'Unlimited access' : `${generationsRemaining} generations left`}
                                </p>
                            </div>
                        </div>
                        {isPro && (
                ...
                >
                    <div className="flex items-center justify-between">
                        <h3 className="font-semibold text-white">Face Profiles ({profiles.length})</h3>
                        <Button
                            variant="ghost"
                            size="sm"
                ...
                >
                    ...
                    <div className="p-4 rounded-2xl bg-secondary space-y-1">
            ...
            <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
                <DialogContent className="bg-card border-white/10 max-w-sm mx-auto">
                    <DialogHeader>
                        <DialogTitle className="text-white text-center">Add Face Profile</DialogTitle>
                    </DialogHeader>
                ...
                ${uploadPreview ? 'border-brand-purple' : 'border-white/20 hover:border-white/40'}`}
                        >
                            {uploadPreview ? (
                                <>
                                    <img
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="My Face"
                                className="w-full px-4 py-3 rounded-xl bg-secondary border border-white/10 text-white placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-brand-purple"
                            />
                        </div>
                        ...
                        <Button
                            ...
                            className="w-full h-12 gradient-primary font-semibold disabled:opacity-50"
                        >
                            {isUploading ? (
