...
const proFeatures = [
    { icon: Sparkles, label: 'Unlock all styles', description: '12+ premium style packs' },
    { icon: Zap, label: 'Unlimited generations', description: 'No monthly limits' },
    { icon: Crown, label: 'No watermarks', description: 'Download ready-to-use photos' },
