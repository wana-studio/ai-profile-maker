  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-muted-foreground">Upload once. Reuse forever.</p>
      </div>
        ...
        <AnimatePresence mode="wait">
          {uploadPreview ? (
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className={`h-64 rounded-3xl border-2 border-dashed flex flex-col items-center justify-center gap-4 transition-colors ${
                isDragActive
                  ? "border-brand-orange bg-brand-orange/10"
                  : "border-muted-foreground/30 hover:border-muted-foreground/50"
              }`}
            >
              <div className="p-4 rounded-full gradient-warm">
      ...
      <span className="text-xl font-semibold my-4 block text-center">
