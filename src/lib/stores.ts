...
interface CreateFlowState {
    ...
    setOption: (key: keyof CreateFlowState['options'], value: boolean) => void;
...
// Gallery store
type Category = 'work' | 'dating' | 'social' | 'anonymous' | 'creative' | 'travel';
